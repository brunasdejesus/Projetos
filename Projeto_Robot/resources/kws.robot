...
***Keywords***  
Dado que acesso a págima principal  
    Go To   ${base_url}    
...
Dado que "${produto}" é um dos meus prato
...
Quando faço o cadastro desse item
    ...
    Wait Until Page Contains Element    ${CAMPO_IMAGEM}   5
...
E que "${produto}" está cadastrado no meu dashboard
    ...
    &{payload}=     Create Dictionary       name=${produto}     plate=Tipo      price=18.00
...
Então devo receber uma notificação de pedido desse produto
    ...
    Wait Until Page Contains         ${mensagem_esperada}        50

E posso aceitar ou rejeitar esse pedido
    Wait Until Page Contains        ACEITAR     50
    Wait Until Page Contains        REJEITAR    50
